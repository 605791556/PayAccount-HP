...
enum EM_SOCK_CMD
{
	...
	SOCK_CMD_GET_CHART_YEAR,//获取年份图表
	SOCK_CMD_GET_CHART_MONTH,//获取月份图表
	SOCK_CMD_MAX
};
...
enum EM_GET_CHART_YEAR
{
	EM_GET_CHART_YEAR_YEAR,//哪一年
	EM_GET_CHART_YEAR_VALUE,//年对应数据
	EM_GET_CHART_YEAR_MAX
};
extern const char CHART_YEAR[EM_GET_CHART_YEAR_MAX][CMD_CHAR_MAX];

enum EM_GET_CHART_MONTH
{
	EM_GET_CHART_MONTH_YEAR,
	EM_GET_CHART_MONTH_MONTH,//哪一月
	EM_GET_CHART_MONTH_VALUE,//月对应数据
	EM_GET_CHART_MONTH_MAX
};
extern const char CHART_MONTH[EM_GET_CHART_MONTH_MAX][CMD_CHAR_MAX];
